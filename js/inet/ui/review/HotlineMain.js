...
$(function () {
  ...
  /**
   * @type {iNet.ui.review.HotlineQuestionList}
   */
  var list = new iNet.ui.review.HotlineQuestionList();
  /**
   * @type {iNet.ui.review.HotlineContent}
   */
  var content = null;
  /**
  ...
  /**
   * @param {iNet.ui.review.HotlineQuestionList} parent
   * @returns {iNet.ui.review.HotlineContent}
   */
  var loadContentWg = function (parent) {
    if (!content) {
      content = new iNet.ui.review.HotlineContent();
