 ...
 * @project cms-admin
 * @author vannbt
 * @file ListAllQuestion.js
 */
$(function () {
  /**
   * @class iNet.ui.exchange.ListAllQuestion
   * @extends iNet.Component
   */
  iNet.ns('iNet.ui.exchange.ListAllQuestion');
  iNet.ui.exchange.ListAllQuestion = function (options) {
    var _this = this;
    iNet.apply(this, options || {});
    this.id='wg-list-question-main';
    this.gridID='grid-list-question-main';
    this.module='topic';
    ...
    this.basicSearch = function () {
      this.id = 'list-basic-search-question-all';
    };
    ...
    iNet.ui.exchange.ListAllQuestion.superclass.constructor.call(this);
    this.getGrid().on('click',function(record){
      _this.fireEvent(_this.getEvent('open'),record,_this)
    });
  };
  iNet.extend(iNet.ui.exchange.ListAllQuestion, iNet.ui.ListAbstract, {});
});
