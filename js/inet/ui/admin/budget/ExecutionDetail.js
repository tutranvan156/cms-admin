...
$(function () {
  /**
   * @class iNet.ui.admin.ExecutionDetail
   * @extends iNet.ui.WidgetExt
   */
  iNet.ns('iNet.ui.admin.ExecutionDetail');
  iNet.ui.admin.ExecutionDetail = function (options) {
    var _this = this;
    iNet.apply(this, options || {});
    this.id = 'execution-detail-wg';
    ...
    this.formValidator = new iNet.ui.form.Validate({
      ...
      rules: [{
        ...
        id: this.form.period.prop('id'),
        validate: function (v) {
          if (iNet.isEmpty(v))
            return String.format(iNet.resources.message.field_not_empty, _this.getText('period'));
        }
      }]
    });
    ...
    iNet.ui.admin.ExecutionDetail.superclass.constructor.call(this);
  ...
  iNet.extend(iNet.ui.admin.ExecutionDetail, iNet.ui.WidgetExt, {
