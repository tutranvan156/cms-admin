/**
 * #PACKAGE: admin
 * #MODULE: socioeconomic-report-category
 */
/**
...
$(function () {
  var level = 0;
  /**
   * @class iNet.ui.admin.SocioeconomicReportCategory
   * @extends iNet.ui.ListAbstract
   */
  iNet.ns('iNet.ui.admin.SocioeconomicReportCategory');
  iNet.ui.admin.SocioeconomicReportCategory = function (options) {
    var _this = this;
    ...
    iNet.ui.admin.SocioeconomicReportCategory.superclass.constructor.call(this);
    ...
    this.getGrid().on('save', function (record) {
      record.group = CMSConfig.GROUP_ECONOMY_REPORT;
  ...
  iNet.extend(iNet.ui.admin.SocioeconomicReportCategory, iNet.ui.ListAbstract, {
  ...
  new iNet.ui.admin.SocioeconomicReportCategory();
});