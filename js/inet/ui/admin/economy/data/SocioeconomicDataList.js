/**
 * #PACKAGE: admin
 * #MODULE: socioeconomic-data-list
 */
/**
...
$(function () {
  /**
   * @class iNet.ui.admin.SocioeconomicDataList
   * @extends iNet.ui.ListAbstract
   */
  iNet.ns('iNet.ui.admin.SocioeconomicDataList');
  iNet.ui.admin.SocioeconomicDataList = function (options) {
    var _this = this;
    ...
    iNet.ui.admin.SocioeconomicDataList.superclass.constructor.call(this);
  ...
  iNet.extend(iNet.ui.admin.SocioeconomicDataList, iNet.ui.ListAbstract, {});
