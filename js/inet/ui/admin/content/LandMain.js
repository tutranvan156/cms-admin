...
$(function () {
  ...
  /**
   * @type {iNet.ui.admin.LandList}
   */
  var list = new iNet.ui.admin.LandList();
  /**
   * @type {iNet.ui.admin.LandDetail}
   */
  var content = null;
  ...
  /**
   * @param {iNet.ui.admin.LandList} parent
   * @returns {iNet.ui.admin.LandDetail}
   */
  function loadContentWg(parent) {
    if (!content) {
      content = new iNet.ui.admin.LandDetail();
