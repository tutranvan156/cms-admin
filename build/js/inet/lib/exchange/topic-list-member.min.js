 ...
 * @project cms-admin
 * @author vannbt
 * @file TopicListMember.js
 */
$(function () {
  /**
   * @class iNet.ui.exchange.TopicListMember
   * @extends iNet.ui.ListAbstract
   */
  iNet.ns('iNet.ui.exchange.TopicListMember');
  iNet.ui.exchange.TopicListMember = function (options) {
    ...
    this.url = {
      ...
      save: iNet.getPUrl('onl/exch/topic/member/save'),
      _delete: iNet.getPUrl('onl/exch/topic/member/delete')
    };

    this.$btn = {
      BACK: $('#content-btn-back-member'),
      CREATED: $('#list-topic-member-btn-create')
    };
    ...
    this.basicSearch = function () {
      this.id = 'list-basic-search-member';
    };
    ...
    iNet.ui.exchange.TopicListMember.superclass.constructor.call(this);
  ...
  iNet.extend(iNet.ui.exchange.TopicListMember, iNet.ui.ListAbstract, {
