 ...
 * @project cms-admin
 * @author nbchicong
 * @file EstimatedMain.js
 */
$(function () {

  $.fn.modalmanager.defaults.resize = true;
  /**
   * @type {iNet.ui.admin.EstimatedList}
   */
  var list = new iNet.ui.admin.EstimatedList();
  /**
   * @type {iNet.ui.admin.EstimatedDetail}
   */
  var content = null;
  ...
  /**
   * @param {iNet.ui.admin.EstimatedList} parent
   * @returns {iNet.ui.admin.EstimatedDetail}
   */
  function loadContentWg(parent) {
    if (!content) {
      content = new iNet.ui.admin.EstimatedDetail();
