...
(function($ , undefined) {
    ...
    var getAttrSettings = function(el, attr_list, prefix) {
    ...
    var Ace_File_Input = function(element , settings) {
        ...
        var attrib_values = getAttrSettings(element, $.fn.ace_file_input.defaults);
